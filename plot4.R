...
## Upper left plot
with(my_data, plot(Time, Global_active_power, type = "n", xlab = "", ylab = "Global Active Power"))
...
## Upper right plot
with(my_data, plot(Time, Voltage, type = "n", xlab = "datetime", ylab = "Voltage"))
with(my_data, lines(Time, Voltage, type = "l"))

## Lower right plot
with(my_data, plot(Time, Global_reactive_power, type = "n", xlab = "datetime", ylab = "Global_reactive_power"))
with(my_data, lines(Time, Global_reactive_power, type = "l"))
